...
export default function () {
  return t`<section>
    ...
    <h3>Dropdown</h3>
    <p>A simple synthetic (not a native select element) dropdown list component written with Arrow. Demonstrates Arrow’s ability to reuse code via components.</p>
    <ul>
